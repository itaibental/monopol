...
var NUM_POSITIONS = 40;
var CORNER_POS = [0, 10, 20, 30];
var PAWNS = ['🔴','🔵','🟢','🟡'];
var PAWN_COLORS = ['#ef4444','#3b82f6','#22c55e','#eab308'];
var DICE_FACES = ['⚀','⚁','⚂','⚃','⚄','⚅'];

// ═══════════════════════════════════════════════
// BOARD MAP BUILDER
// ═══════════════════════════════════════════════
function buildBoardMap(concepts) {
  const BOARD_MAP = {};
  let cIdx = 0;
...
function createGameState(players, sessionId, mode) {
  return {
    players,
    currentPlayer: 0,
    visited: [0],
...
// DICE ROLL
// ═══════════════════════════════════════════════
async function rollDiceAnimation(d1El, d2El) {
...
// CORNER EVENTS
// ═══════════════════════════════════════════════
function handleCorner(pos, player) {
  const msgs = {
